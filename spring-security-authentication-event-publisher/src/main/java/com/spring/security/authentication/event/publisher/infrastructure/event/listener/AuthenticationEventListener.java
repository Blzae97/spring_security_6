package com.spring.security.authentication.event.publisher.infrastructure.event.listener;

import com.spring.security.authentication.event.publisher.infrastructure.event.custom.CustomAuthenticationFailureEvent;
import com.spring.security.authentication.event.publisher.infrastructure.event.custom.CustomAuthenticationSuccessEvent;
...
public class AuthenticationEventListener {
    ...
    public void onFailure(DefaultAuthenticationFailureEvent event) {
        System.out.println("failures = " + event.getException().getMessage());
    }
